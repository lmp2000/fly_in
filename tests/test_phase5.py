"""Manual runner for Phase 5 restricted movement simulation."""
...
def main() -> None:
    """Run a Phase 5 simulation with restricted movement and link capacity."""
    parser = MapParser()
    map_data = parser.parse_file("maps/phase5_map.txt")
